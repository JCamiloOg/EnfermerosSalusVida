...
export default function HeroSection() {
    return (
        <section>
            <div className={` bg-center bg-cover bg-no-repeat text-white py-20`} style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url(${bgImage})` }}>
                <div className="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-24">
                    <div className="flex flex-col w-full lg:w-1/3 justify-center items-start p-8">
                        <h1 className="text-3xl md:text-5xl p-2 text-[#1c64f2] tracking-loose">Enfermeros Salusvida</h1>
                        <h2 className="text-3xl text-[#a4cafe] md:text-5xl leading-relaxed md:leading-snug mb-2">Space : The Timeless Infinity
                        </h2>
                        <p className="text-sm md:text-base text-[#728db1] mb-4">Explore your favourite events and
